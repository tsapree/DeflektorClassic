...
public class GameState extends State {
	...
	int packedLevels[][] = {
		...
		{
			1024, //energySteps
			FLD_LASER_GUN|1,FLD_NULL,FLD_MIRROR,FLD_NULL,FLD_WALL_A|10,FLD_MIRROR,FLD_NULL,FLD_WALL_A|2,FLD_MIRROR,FLD_NULL|5,FLD_PRISM,
			FLD_WALL_A|15,FLD_WALL_A|3,FLD_WALL_A|3,FLD_NULL|4,FLD_WALL_A|10,FLD_NULL|2,FLD_SLIT_A,FLD_NULL,FLD_SLIT_A,FLD_CELL,FLD_NULL,
			FLD_MINE,FLD_NULL|4,FLD_WALL_A|15,FLD_NULL,FLD_WALL_A|10,FLD_SLIT_A,FLD_NULL|2,FLD_MINE,FLD_NULL|2,FLD_PRISM,
			FLD_WALL_A|10,FLD_CELL,FLD_WALL_A|1,FLD_NULL|2,FLD_WALL_A|15,FLD_NULL,FLD_WALL_A|10,FLD_CELL,FLD_NULL,FLD_SLIT_A,FLD_NULL,FLD_SLIT_A,FLD_CELL,FLD_NULL,
			FLD_WALL_A|10,FLD_NULL,FLD_WALL_A|5,FLD_NULL,FLD_CELL,FLD_NULL|2,FLD_WALL_A|11,FLD_WALL_A|3,FLD_WALL_A|2,FLD_NULL|4,FLD_PRISM,
			FLD_WALL_A|10,FLD_CELL,FLD_WALL_A|15,FLD_NULL|2,FLD_CELL,FLD_NULL|2,FLD_CELL,FLD_WALL_A|10,FLD_SLIT_A,FLD_CELL,FLD_SLIT_A,FLD_CELL,FLD_NULL,
			FLD_WALL_A|10,FLD_NULL|3,FLD_WALL_A|5,FLD_WALL_A|12,FLD_WALL_A|12,FLD_NULL|2,FLD_WALL_A|10,FLD_CELL,FLD_NULL|3,FLD_PRISM,
			FLD_WALL_A|10,FLD_NULL|6,FLD_MIRROR,FLD_NULL,FLD_WALL_A|10,FLD_SLIT_A,FLD_CELL,FLD_SLIT_A,FLD_CELL,FLD_WALL_B|3|FLD_EXPLODEONEND,
			FLD_WALL_A|15,FLD_NULL,FLD_MIRROR,FLD_NULL|5,FLD_MINE,FLD_WALL_A|11,FLD_WALL_A|3,FLD_WALL_A|3,FLD_WALL_A|3,FLD_WALL_A|3,FLD_RECEIVER,
			
		},
		//07
		{
			1024, //energySteps
			FLD_CELL,FLD_NULL,FLD_MIRROR,FLD_NULL,FLD_WALL_A|12,FLD_WALL_A|8,FLD_MIRROR,FLD_NULL|3,FLD_MIRROR,FLD_WALL_A|5,FLD_RECEIVER|1,FLD_WALL_B|15|FLD_EXPLODEONEND,FLD_MIRROR,
			FLD_WALL_A|14,FLD_WALL_A|12,FLD_NULL|2,FLD_CELL,FLD_NULL|2,FLD_WALL_A|15,FLD_NULL,FLD_WALL_A|13,FLD_NULL,FLD_WALL_A|5,FLD_WALL_A|12,FLD_WALL_A|13,FLD_NULL,
			FLD_NULL,FLD_CELL,FLD_NULL|3,FLD_WALL_A|3,FLD_NULL|2,FLD_CELL,FLD_WALL_A|5,FLD_NULL|2,FLD_CELL,FLD_WALL_A|5,FLD_NULL,
			FLD_WALL_A|3,FLD_WALL_A|7,FLD_WALL_A|12,FLD_NULL,FLD_WALL_A|5,FLD_WALL_A|10,FLD_NULL,FLD_WALL_A|13,FLD_WALL_A|2,FLD_NULL|2,FLD_MIRROR,FLD_NULL,FLD_WALL_A|15,FLD_NULL,
			FLD_NULL|2,FLD_MIRROR,FLD_NULL|3,FLD_CELL,FLD_WALL_A|5,FLD_WALL_A|14,FLD_WALL_A|12,FLD_NULL|3,FLD_WALL_A|12,FLD_NULL,
			FLD_NULL|2,FLD_WALL_A|3,FLD_WALL_A|3,FLD_CELL,FLD_NULL|3,FLD_WALL_A|12,FLD_NULL,FLD_CELL,FLD_NULL,FLD_WALL_A|5,FLD_NULL|2,
			FLD_MIRROR,FLD_NULL|2,FLD_WALL_A|4,FLD_WALL_A|10,FLD_NULL,FLD_WALL_A|5,FLD_NULL|2,FLD_WALL_A|10,FLD_WALL_A|15,FLD_NULL,FLD_WALL_A|5,FLD_NULL,FLD_MIRROR,
			FLD_WALL_A|3,FLD_WALL_A|3,FLD_NULL|2,FLD_WALL_A|10,FLD_CELL,FLD_WALL_A|5,FLD_NULL,FLD_MIRROR,FLD_NULL|4,FLD_CELL,FLD_NULL,
			FLD_LASER_GUN|1,FLD_NULL,FLD_MIRROR,FLD_NULL,FLD_WALL_A|11,FLD_WALL_A|3,FLD_WALL_A|14,FLD_CELL,FLD_NULL|2,FLD_WALL_A|3,FLD_WALL_A|3,FLD_WALL_A|3,FLD_WALL_A|3,FLD_WALL_A|15,
		},
		//08
		{
			1024, //energySteps
			FLD_LASER_GUN|2,FLD_WALL_B|5,FLD_WALL_B|15,FLD_WALL_A|15,FLD_WALL_A|12,FLD_WALL_A|12,FLD_WALL_A|12,FLD_WALL_A|13,FLD_WALL_A|10,FLD_NULL,FLD_WALL_A|12,FLD_NULL,FLD_MINE,FLD_NULL,FLD_WARPBOX|0,
			FLD_NULL,FLD_WALL_B|5,FLD_RECEIVER|1,FLD_WALL_A|5|FLD_EXPLODEONEND,FLD_CELL,FLD_CELL,FLD_CELL,FLD_WALL_A|4,FLD_WALL_A|8,FLD_NULL|3,FLD_MIRROR,FLD_NULL|2,
			FLD_NULL,FLD_WALL_B|5,FLD_WALL_B|15,FLD_WALL_A|14,FLD_CELL,FLD_MINE,FLD_CELL,FLD_CELL,FLD_WALL_A|13,FLD_NULL|6,
			FLD_NULL|2,FLD_WALL_A|15,FLD_WALL_A|10,FLD_MINE,FLD_MINE,FLD_MINE,FLD_CELL,FLD_WALL_A|5,FLD_WALL_A|3,FLD_NULL|5,
			FLD_MIRROR,FLD_NULL,FLD_PRISM,FLD_NULL,FLD_CELL,FLD_MINE,FLD_CELL,FLD_MINE,FLD_NULL,FLD_PRISM,FLD_NULL|4,FLD_MIRROR,
			FLD_NULL|2,FLD_WALL_A|12,FLD_WALL_A|10,FLD_MINE,FLD_CELL,FLD_MINE,FLD_CELL,FLD_WALL_A|5,FLD_WALL_A|12,FLD_NULL|4,FLD_MIRROR,
			FLD_NULL|3,FLD_WALL_A|11,FLD_WALL_A|3,FLD_WALL_A|3,FLD_WALL_A|3,FLD_WALL_A|3,FLD_WALL_A|7,FLD_NULL|4,FLD_WALL_B|1,FLD_WALL_B|3,
			FLD_NULL|11,FLD_WALL_B|7,FLD_NULL,FLD_WALL_B|12,FLD_CELL,
			FLD_NULL|2,FLD_MIRROR,FLD_NULL,FLD_MINE,FLD_MIRROR,FLD_MINE,FLD_NULL,FLD_MIRROR,FLD_NULL|2,FLD_WALL_B|10,FLD_WARPBOX|0,FLD_WALL_B|1,FLD_WALL_B|15,
		},
		//09
		{
			1024, //energySteps
			FLD_MINE,FLD_CELL,FLD_CELL,FLD_PRISM,FLD_CELL,FLD_CELL,FLD_CELL,FLD_LASER_GUN|2,FLD_CELL,FLD_CELL,FLD_CELL,FLD_PRISM,FLD_CELL,FLD_CELL,FLD_MINE,
			FLD_CELL,FLD_CELL,FLD_CELL,FLD_CELL,FLD_MINE,FLD_CELL,FLD_CELL,FLD_NULL,FLD_CELL,FLD_CELL,FLD_MINE,FLD_CELL,FLD_CELL,FLD_CELL,FLD_CELL,
			FLD_CELL,FLD_CELL,FLD_CELL,FLD_CELL,FLD_CELL,FLD_CELL,FLD_CELL,FLD_MIRROR,FLD_CELL,FLD_CELL,FLD_CELL,FLD_CELL,FLD_CELL,FLD_CELL,FLD_CELL,
			FLD_CELL,FLD_CELL,FLD_CELL,FLD_CELL,FLD_CELL,FLD_CELL,FLD_CELL,FLD_CELL,FLD_CELL,FLD_CELL,FLD_CELL,FLD_CELL,FLD_CELL,FLD_CELL,FLD_CELL,
			FLD_CELL,FLD_CELL,FLD_CELL,FLD_MIRROR,FLD_CELL,FLD_CELL,FLD_CELL,FLD_CELL,FLD_CELL,FLD_CELL,FLD_CELL,FLD_MIRROR,FLD_CELL,FLD_CELL,FLD_CELL,
			FLD_CELL,FLD_CELL,FLD_CELL,FLD_CELL,FLD_CELL,FLD_CELL,FLD_CELL,FLD_CELL,FLD_CELL,FLD_CELL,FLD_CELL,FLD_CELL,FLD_CELL,FLD_CELL,FLD_CELL,
			FLD_CELL,FLD_CELL,FLD_CELL,FLD_CELL,FLD_CELL,FLD_CELL,FLD_CELL,FLD_MIRROR,FLD_CELL,FLD_CELL,FLD_CELL,FLD_CELL,FLD_CELL,FLD_CELL,FLD_CELL,
			FLD_CELL,FLD_CELL,FLD_CELL,FLD_CELL,FLD_MINE,FLD_CELL,FLD_CELL,FLD_WALL_B|3|FLD_EXPLODEONEND,FLD_CELL,FLD_CELL,FLD_MINE,FLD_CELL,FLD_CELL,FLD_CELL,FLD_CELL,
			FLD_MINE,FLD_CELL,FLD_CELL,FLD_PRISM,FLD_CELL,FLD_CELL,FLD_CELL,FLD_RECEIVER|0,FLD_CELL,FLD_CELL,FLD_CELL,FLD_PRISM,FLD_CELL,FLD_CELL,FLD_MINE,
		},
		//10
		{
			1024, //energySteps
			FLD_MIRROR,FLD_CELL,FLD_MIRROR,FLD_CELL,FLD_MIRROR,FLD_NULL,FLD_MIRROR,FLD_NULL,FLD_MIRROR,FLD_CELL,FLD_MIRROR,FLD_MINE,FLD_MIRROR,FLD_NULL,FLD_MIRROR,
			FLD_NULL,FLD_MIRROR,FLD_NULL,FLD_MIRROR,FLD_CELL,FLD_MIRROR,FLD_CELL,FLD_MIRROR,FLD_NULL,FLD_MIRROR,FLD_NULL,FLD_MIRROR,FLD_NULL,FLD_MIRROR,FLD_MINE,
			FLD_MIRROR,FLD_CELL,FLD_MIRROR,FLD_MINE,FLD_MIRROR,FLD_NULL,FLD_MIRROR,FLD_NULL,FLD_MIRROR,FLD_MINE,FLD_MIRROR,FLD_CELL,FLD_MIRROR,FLD_CELL,FLD_MIRROR,
			FLD_NULL,FLD_MIRROR,FLD_NULL,FLD_MIRROR,FLD_NULL,FLD_MIRROR,FLD_NULL,FLD_MIRROR,FLD_CELL,FLD_MIRROR,FLD_NULL,FLD_MIRROR,FLD_NULL,FLD_MIRROR,FLD_CELL,
			FLD_MIRROR,FLD_NULL,FLD_MIRROR,FLD_CELL,FLD_MIRROR,FLD_NULL,FLD_MIRROR,FLD_NULL,FLD_MIRROR,FLD_NULL,FLD_MIRROR,FLD_NULL,FLD_MIRROR,FLD_CELL,FLD_MIRROR,
			FLD_NULL,FLD_MIRROR,FLD_NULL,FLD_MIRROR,FLD_NULL,FLD_MIRROR,FLD_CELL,FLD_MIRROR,FLD_NULL,FLD_MIRROR,FLD_CELL,FLD_MIRROR,FLD_NULL,FLD_MIRROR,FLD_NULL,
			FLD_MIRROR,FLD_NULL,FLD_MIRROR,FLD_NULL,FLD_MIRROR,FLD_CELL,FLD_MIRROR,FLD_NULL,FLD_MIRROR,FLD_NULL,FLD_MIRROR,FLD_NULL,FLD_MIRROR,FLD_CELL,FLD_MIRROR,
			FLD_NULL,FLD_MIRROR,FLD_CELL,FLD_MIRROR,FLD_NULL,FLD_MIRROR,FLD_NULL,FLD_MIRROR,FLD_CELL,FLD_MIRROR,FLD_CELL,FLD_MIRROR,FLD_NULL,FLD_MIRROR,FLD_MINE|FLD_EXPLODEONEND,
			FLD_LASER_GUN|0,FLD_NULL,FLD_MIRROR,FLD_NULL,FLD_MIRROR,FLD_CELL,FLD_MIRROR,FLD_MINE,FLD_MIRROR,FLD_NULL,FLD_MIRROR,FLD_CELL,FLD_MIRROR,FLD_NULL,FLD_RECEIVER|0,
		},
		//11
		{
			1024, //energySteps
			FLD_RECEIVER|2,FLD_NULL|3,FLD_MIRROR,FLD_NULL,FLD_WARPBOX|0,FLD_NULL,FLD_CELL,FLD_NULL|2,FLD_MINE,FLD_NULL,FLD_MINE,FLD_NULL,
			FLD_MINE|FLD_EXPLODEONEND,FLD_NULL,FLD_CELL,FLD_WALL_A|11,FLD_WALL_A|3,FLD_NULL|3,FLD_WALL_A|14,FLD_MINE,FLD_NULL|2,FLD_CELL,FLD_NULL|2,
			FLD_MIRROR,FLD_NULL,FLD_SLIT_A,FLD_NULL,FLD_WALL_A|10,FLD_NULL|3,FLD_WALL_A|10,FLD_NULL,FLD_CELL,FLD_MINE,FLD_NULL|2,FLD_CELL,
			FLD_NULL,FLD_MIRROR,FLD_NULL,FLD_CELL,FLD_WALL_A|8,FLD_NULL|4,FLD_CELL,FLD_NULL|3,FLD_MINE,FLD_WALL_A|5,
			FLD_WALL_A|3,FLD_WALL_A|3,FLD_WALL_A|3,FLD_WALL_A|10,FLD_SLIT_A,FLD_NULL,FLD_MIRROR,FLD_NULL,FLD_WALL_A|10,FLD_NULL,FLD_WALL_A|10,FLD_NULL|3,FLD_WALL_A|5,
			FLD_CELL,FLD_CELL,FLD_CELL,FLD_WALL_A|10,FLD_NULL|4,FLD_WALL_A|12,FLD_NULL,FLD_WALL_A|13,FLD_NULL,FLD_MIRROR,FLD_NULL,FLD_WALL_A|5,
			FLD_CELL,FLD_PRISM,FLD_CELL,FLD_WALL_A|15,FLD_NULL|2,FLD_WALL_A|11,FLD_NULL,FLD_SLIT_A,FLD_NULL|5,FLD_WALL_A|15,
			FLD_NULL|3,FLD_WALL_A|10,FLD_NULL,FLD_WALL_A|10,FLD_WALL_A|5,FLD_NULL|2,FLD_WALL_A|5,FLD_WALL_A|3,FLD_NULL|2,FLD_WALL_A|12,FLD_WALL_A|15,
			FLD_NULL,FLD_WARPBOX|0,FLD_NULL,FLD_WALL_A|10,FLD_MIRROR,FLD_CELL,FLD_WALL_A|5,FLD_NULL,FLD_MIRROR,FLD_NULL|3,FLD_MIRROR,FLD_NULL,FLD_LASER_GUN|3,
		},		
		//12
		{
			1024, //energySteps
