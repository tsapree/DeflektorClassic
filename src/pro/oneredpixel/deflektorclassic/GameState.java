...
public class GameState extends State {
	...
	int packedLevels[][] = {
		...
		//06
		{
			...
			WL_A|15,WL_A|3,WL_A|3,NULL|4,WL_A|10,NULL|2,SL_A|3,NULL,SL_A|5,CELL,NULL,
			MINE,NULL|4,WL_A|15,NULL,WL_A|10,SL_A|5,NULL|2,MINE,NULL|2,PRSM,
			WL_A|10,CELL,WL_A|1,NULL|2,WL_A|15,NULL,WL_A|10,CELL,NULL,SL_A|1,NULL,SL_A|1,CELL,NULL,
			WL_A|10,NULL,WL_A|5,NULL,CELL,NULL|2,WL_A|11,WL_A|3,WL_A|2,NULL|4,PRSM,
			WL_A|10,CELL,WL_A|15,NULL|2,CELL,NULL|2,CELL,WL_A|10,SL_A|2,CELL,SL_A|5,CELL,NULL,
			WL_A|10,NULL|3,WL_A|5,WL_A|12,WL_A|12,NULL|2,WL_A|10,CELL,NULL|3,PRSM,
			WL_A|10,NULL|6,MIRR,NULL,WL_A|10,SL_A|3,CELL,SL_A|5,CELL,WL_B|3|EXPLODE,
		...
		//11
		{
			...
			MIRR,NULL,SL_A|2,NULL,WL_A|10,NULL|3,WL_A|10,NULL,CELL,MINE,NULL|2,CELL,
			NULL,MIRR,NULL,CELL,WL_A|8,NULL|4,CELL,NULL|3,MINE,WL_A|5,
			WL_A|3,WL_A|3,WL_A|3,WL_A|10,SL_A|7,NULL,MIRR,NULL,WL_A|10,NULL,WL_A|10,NULL|3,WL_A|5,
			CELL,CELL,CELL,WL_A|10,NULL|4,WL_A|12,NULL,WL_A|13,NULL,MIRR,NULL,WL_A|5,
			CELL,PRSM,CELL,WL_A|15,NULL|2,WL_A|11,NULL,SL_A|2,NULL|5,WL_A|15,
		...
		//13
		{
			...
			NULL,WL_A|10,NULL|2,WL_A|10,SL_A|4,NULL|2,WL_A|10,WL_A|5,NULL,WL_A|4,NULL|2,MIRR,
		...
		{
			1024, //energySteps
			RCVR|1,SL_A|EXPLODE,NULL,SL_A|4,SL_A|3,NULL|3,CELL,NULL|4,MIRR,NULL,
			NULL|2,CELL,NULL|3,MINE,SL_A|6,SL_A|6,SL_A|6,CELL,NULL,SL_A|1,NULL,SL_A|4,
			MINE,SL_A,SL_A,SL_A,NULL,MIRR,NULL|5,MIRR,NULL|2,SL_A|4,
			SL_A|2,NULL|6,SL_A|1,NULL,MIRR,NULL|2,CELL,NULL|2,
			NULL|3,MIRR,NULL,SL_A|3,NULL|2,CELL,NULL|3,SL_A|6,SL_A|6,MINE,
			NULL,SL_A|2,NULL|3,SL_A|3,NULL,MIRR,NULL,SL_A|4,SL_A|4,CELL,NULL|3,
			CELL,NULL|4,SL_A|3,NULL|4,SL_A|4,NULL|2,MIRR,CELL,
			SL_A|3,CELL,NULL|2,MINE,NULL|3,SL_A|2,NULL|6,
		...
		{
			1024, //energySteps
			WL_A|15,WL_A|12,WL_A|12,WL_A|12,WL_A|12,WL_A|12,WL_A|10,WL_B|15,WL_A|12,WL_A|12,WL_A|15,NULL,SL_A|7,CELL,SL_A|2,
			NULL|4,WARP|0,NULL,WL_A|10,NULL,WL_A|5,NULL|3,CELL,CELL,CELL,
			PRSM,NULL,PRSM,NULL|2,MIRR,WL_A|10,MIRR,WL_A|5,NULL|3,SL_A|6,CELL,SL_A|5,
			CELL,NULL|3,WL_A|5,WL_A|12|EXPLODE,WL_A|10,NULL,WL_A|5,NULL,MIRR,NULL|3,CELL,
			PRSM,CELL,PRSM,NULL,WL_A|5,RCVR|0,WL_A|15,LASR|0,WL_A|15,NULL|3,SL_A|2,NULL,SL_A|1,
			CELL,NULL|3,WL_A|4,WL_A|12,WL_A|12,WL_A|12,WL_A|8,NULL|5,CELL,
			PRSM,CELL,PRSM,NULL,MIRR,WL_A|5,WL_A|3,WL_A|14,NULL|2,WL_A|15,NULL,SL_A|1,NULL,SL_A|6,
		...
		//26
		{
			...
			WL_B|15,WL_B|12,WL_B|8,NULL,WL_B|4,WL_B|12,WL_B|15,WL_B|15,WL_B|10,NULL,SL_B|7,CELL,SL_B|3,NULL,WL_A|5,
			MINE,MIRR,CELL,PRSM,CELL,MIRR,MINE,WL_B|5,WL_B|10,SL_B|7,NULL|3,MIRR,WL_A|4,
		...
		//31
		{
			...
			CELL,CELL,CELL,PRSM,WARP|1,WL_A|3,NULL|3,SL_B,NULL,SL_B|1,NULL|3,
			MINE,CELL,CELL,CELL,CELL,WL_A|5,NULL|5,CELL,NULL,CELL,NULL,
			CELL,MINE,CELL,CELL,CELL,WL_A|5,NULL|2,MIRR,NULL,SL_B|1,NULL,SL_B|5,NULL|2,
		...
		//33
		{
			...
			WL_B|12|EXPLODE,CELL,SL_B|7,CELL,MINE,WL_A|5,NULL,MIRR,NULL|6,WL_A|5,
			PRSM,NULL|2,MINE,MINE,WL_A|5,NULL|2,WL_A|3,WL_A|3,WL_A|10,NULL|3,WL_A|5,
			NULL,CELL,SL_B|6,MINE,SL_B|4,WL_A|5,CELL,NULL|2,CELL,NULL|2,WL_A|14,PRSM,WL_A|12,
			PRSM,NULL|4,WL_A|4,WL_A|12,WL_A|8,NULL|2,CELL,NULL,WL_A|10,CELL,CELL,
			NULL,CELL,SL_B|2,CELL,SL_B|2,NULL,CELL,WL_A|5,NULL,WL_A|15,NULL|2,WL_A|8,CELL,CELL,
			PRSM,NULL|2,MINE,NULL|2,SL_B|3,WL_A|5,NULL,WL_A|15,NULL|3,MINE,MINE,
			CELL,CELL,PRSM,NULL,SL_B|3,NULL|2,WL_A|5,NULL|4,WL_A|12,WL_A|12,WL_A|15,
		...
		//36
		{
			...
			NULL,CELL,NULL|5,WL_A|3,WL_A|3,WL_A|3,MINE,CELL,MIRR,CELL,WL_B|10,
			WL_B|10,NULL,WL_B|15,WL_B|15,MIRR,NULL|2,WL_A|10,CELL,CELL,WL_A|12,CELL,CELL,CELL,WL_B|10,
			WL_B|15,NULL,CELL,CELL,SL_B|6,NULL,MIRR,WL_A|10,CELL,CELL,PRSM,MINE,WL_B|14,WL_B|12,WL_B|8,
		},
		//37
		{
			1024, //energySteps
		...
		//39
		{
			...
			CELL,SL_A|3,CELL,CELL,CELL,CELL,CELL,CELL,CELL,CELL,CELL,MIRR,CELL,CELL,CELL,
			CELL,CELL,CELL,CELL,CELL,CELL,CELL,CELL,CELL,CELL,CELL,CELL,CELL,CELL,CELL,
			...
			MINE|EXPLODE,CELL,CELL,CELL,MIRR,CELL,CELL,CELL,CELL,CELL,SL_A,CELL,CELL,CELL,NULL,
		...
		//40
		{
			...
			CELL,MIRR,NULL,SL_A|5,CELL,MIRR,NULL,SL_A|5,CELL,MIRR,NULL,SL_A|7,NULL,MIRR,NULL,
			MIRR,NULL,MIRR,CELL,MIRR,NULL,MIRR,NULL,MIRR,NULL,MIRR,CELL,MIRR,NULL,MIRR,
			CELL,MIRR,NULL,SL_A|3,NULL,MIRR,CELL,SL_A|5,NULL,MIRR,NULL,SL_A|2,NULL,MIRR,MINE,
		...
		//41
		{
			...
			WL_A|15,NULL|5,SL_A|2,NULL,WL_A|13,NULL|2,WL_A|15,CELL,PRSM,CELL,
			WL_A|10,NULL,PRSM,NULL,WL_A|11,NULL,WL_A|3,NULL|4,WL_A|5,CELL,CELL,CELL,
			WL_A|10,NULL|3,WL_A|5,NULL,WL_A|5,NULL,MIRR,NULL,SL_A|7,WL_A|5,WL_A|12,WL_A|12,WL_A|12,
			WL_A|10,MINE,NULL|3,CELL,NULL|4,WL_A|1,NULL,CELL,CELL,CELL,
			CELL,NULL|2,MINE,CELL,NULL,WL_A|5,NULL|3,WL_A|5,NULL,CELL,MIRR,CELL,
		...
		{
			1024, //energySteps
			MIRR,MINE,MIRR,CELL,MIRR,NULL,MIRR,MINE,MIRR,NULL,MIRR,CELL,MIRR,NULL,LASR|2,
			MINE,MIRR,NULL,MIRR,NULL,MIRR,CELL,MIRR,NULL,MIRR,NULL,MIRR,CELL,MIRR,NULL,
			MIRR,CELL,MIRR,CELL,MIRR,NULL,MIRR,NULL,MIRR,CELL,MIRR,NULL,MIRR,NULL,MIRR,
			MINE,MIRR,NULL,MIRR,CELL,MIRR,NULL,MIRR,MINE,MIRR,NULL,MIRR,NULL,MIRR,NULL,
			MIRR,NULL,MIRR,NULL,MIRR,NULL,MIRR,MINE|EXPLODE,RCVR|3,MINE,MIRR,CELL,MIRR,NULL,MIRR,
			CELL,MIRR,CELL,MIRR,NULL,MIRR,NULL,MIRR,MINE,MIRR,NULL,MIRR,NULL,MIRR,CELL,
			MIRR,CELL,MIRR,NULL,MIRR,MINE,MIRR,NULL,MIRR,NULL,MIRR,NULL,MIRR,MINE,MIRR,
			MINE,MIRR,MINE,MIRR,NULL,MIRR,NULL,MIRR,CELL,MIRR,NULL,MIRR,CELL,MIRR,MINE,
			MIRR,CELL,MIRR,NULL,MIRR,CELL,MIRR,CELL,MIRR,NULL,MIRR,CELL,MIRR,CELL,MIRR,
		},
		//46
		{
			1024, //energySteps
		...
		//47
		{
			...
			MINE,NULL|6,SL_A|5,NULL|2,MINE,NULL|2,CELL,SL_A|4|EXPLODE,
			LASR|1,NULL,MIRR,NULL,SL_A|4,SL_A|4,NULL|5,SL_A|2,NULL|2,MIRR,
			NULL|7,MIRR,NULL,SL_A|3,NULL|3,SL_A|3,NULL,
			MINE,SL_A|6,SL_A|6,NULL|3,CELL,NULL|2,SL_A|3,NULL,MIRR,NULL,CELL,NULL,
			NULL|2,CELL,NULL,SL_A|7,NULL|2,SL_A|2,NULL,CELL,NULL|4,SL_A|2,
			NULL,SL_A|2,NULL|7,MIRR,NULL,SL_A,SL_A,SL_A,MINE,
			CELL,NULL,SL_A|2,NULL,MIRR,NULL,SL_A|6,SL_A|6,MINE,NULL|3,CELL,NULL|2,
		...
		//49
		{
			...
			CELL,CELL,CELL,CELL,CELL,CELL,CELL,CELL,CELL,CELL,CELL,CELL,CELL,CELL,CELL,
			CELL,CELL,CELL,CELL,CELL,CELL,CELL,MIRR,CELL,CELL,CELL,MIRR,CELL,CELL,CELL,
			CELL,CELL,CELL,MIRR,CELL,CELL,CELL,CELL,CELL,CELL,CELL,CELL,CELL,CELL,CELL,
		...
		//50
		{
			1024, //energySteps
			MIRR,CELL,MIRR,NULL,MIRR,NULL,MIRR,NULL,MIRR,CELL,MIRR,NULL,MIRR,MINE,MIRR,
			NULL,MIRR,MINE,MIRR,CELL,MIRR,CELL,MIRR,NULL,MIRR,NULL,MIRR,CELL,MIRR,NULL,
			MIRR,CELL,SL_B,NULL,MIRR,NULL,MIRR,NULL,MIRR,MINE,MIRR,CELL,MIRR,CELL,MIRR,
			NULL,MIRR,CELL,MIRR,NULL,MIRR,NULL,MIRR,NULL,MIRR,NULL,MIRR,NULL,MIRR,NULL,
			RCVR|2,NULL,MIRR,CELL,MIRR,NULL,MIRR,MINE,MIRR,CELL,MIRR,NULL,MIRR,CELL,LASR,
			MINE,MIRR,NULL,MIRR,MINE,MIRR,CELL,MIRR,NULL,MIRR,CELL,MIRR,NULL,MIRR,CELL,
			MIRR,NULL,MIRR,NULL,MIRR,NULL,MIRR,NULL,MIRR,NULL,MIRR,NULL,SL_B|5,NULL,MIRR,
			NULL,MIRR,CELL,MIRR,CELL,MIRR,NULL,MIRR,CELL,MIRR,NULL,MIRR,NULL,MIRR,CELL,
		...
		//51
		{
			...
			WL_A|10,NULL,SL_A|5,CELL,SL_A|1,NULL,WL_B|14,NULL,WL_B|13,NULL,WL_A|1,WL_A|3,WL_A|3,WL_A|3,WL_A|3,
		...
		//52
		{
			...
			CELL,NULL|13,CELL,
			SL_A|2,CELL,SL_A|3,NULL,SL_A|1,NULL,SL_A|5,NULL,SL_A|4,NULL,SL_A|2,NULL,SL_A|5,CELL,SL_A|6,
			CELL,NULL,CELL,NULL|9,CELL,NULL,CELL,
			SL_A|7,CELL,SL_A|4,NULL,SL_A|4,CELL,SL_A|6,CELL,SL_A|2,CELL,SL_A|5,NULL,SL_A,CELL,SL_A|3,
		},
		//53
		{
			1024, //energySteps
			WL_A|10,MINE,CELL,MIRR,NULL|4,SL_B|4,CELL,MINE,WL_A|5,WL_A|15,WL_A|15,WL_A|15,
			...
			WL_B|12,NULL,WL_A|12,WL_A|15,WL_A|15,WL_A|10,MIRR,CELL,WL_A|10,WL_A|5,WL_A|15,WL_A|15,WL_A|15,WL_A|14,WL_A|5,
		...
		//54
		{
			...
			CELL,CELL,CELL,CELL,CELL,CELL,CELL,CELL,CELL,CELL,CELL,CELL,CELL,CELL,CELL,
			CELL,CELL,CELL,CELL,CELL,CELL,CELL,CELL,CELL,CELL,CELL,CELL,CELL,CELL,CELL,
			CELL,CELL,CELL,CELL,MIRR,CELL,CELL,CELL,MIRR,CELL,CELL,MIRR,CELL,CELL,CELL,
		...
		{
			1024, //energySteps
			MIRR,CELL,MIRR,CELL,MIRR,CELL,MIRR,NULL,MIRR,NULL,MIRR,CELL,MIRR,CELL,MIRR,
			MINE,MIRR,MINE,MIRR,NULL,MIRR,CELL,MIRR,CELL,MIRR,NULL,MIRR,MINE,MIRR,CELL,
			MIRR,CELL,MIRR,NULL,MIRR,NULL,MIRR,NULL,MIRR,CELL,MIRR,NULL,MIRR,NULL,MIRR,
			MINE,MIRR,NULL,MIRR,NULL,MIRR,CELL,MIRR,NULL,MIRR,NULL,MIRR,NULL,MIRR,NULL,
			RCVR|1,MINE|EXPLODE,MIRR,NULL,MIRR,NULL,MIRR,MINE,MIRR,NULL,MIRR,NULL,MIRR,NULL,LASR|3,
			MINE,MIRR,NULL,MIRR,NULL,MIRR,CELL,MIRR,NULL,MIRR,NULL,MIRR,NULL,MIRR,NULL,
			MIRR,CELL,MIRR,NULL,MIRR,NULL,MIRR,NULL,MIRR,CELL,MIRR,NULL,MIRR,NULL,MIRR,
			MINE,MIRR,MINE,MIRR,NULL,MIRR,CELL,MIRR,CELL,MIRR,NULL,MIRR,MINE,MIRR,CELL,
			MIRR,CELL,MIRR,CELL,MIRR,CELL,MIRR,NULL,MIRR,NULL,MIRR,CELL,MIRR,CELL,MIRR,
		...
		//58
		{
			...
			CELL,CELL,CELL,CELL,CELL,CELL,CELL,NULL,CELL,CELL,CELL,CELL,CELL,CELL,CELL,
			CELL,CELL,CELL,CELL,CELL,CELL,CELL,NULL,CELL,CELL,CELL,CELL,CELL,CELL,CELL,
			CELL,MIRR,CELL,MIRR,CELL,MIRR,MINE,NULL,MINE,MIRR,CELL,MIRR,CELL,MIRR,CELL,
			MIRR,MIRR,MIRR,MIRR,MIRR,MIRR,MIRR,MIRR,MIRR,MIRR,MIRR,MIRR,MIRR,MIRR,MIRR,
			MIRR,NULL,MIRR,NULL,MIRR,NULL|5,MIRR,NULL,MIRR,NULL,MIRR,
		...
		//59
		{
			...
			MIRR,NULL,MIRR,MIRR,MINE,MIRR,MIRR,CELL,MIRR,MIRR,MINE,MIRR,MIRR,NULL,MIRR,
