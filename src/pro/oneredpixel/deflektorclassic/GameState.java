...
public class GameState extends State {
	...
	final int SL_A = 0xa00;			//reflects laser if angle is different - желтые
	final int SL_B = 0xb00;			//if the angle is different the laser will stop - голубые
	final int _EXPL = 0xc00;			//взрыв CELL/WALL/MINE при прожигании-при завершении уровня
	...
	void drawBeam(int beamX, int beamY, int beamAngle) {
		...
		while ((endBeam--)>0) {
			...
			//Если луч проходит между двумя стенами - погасить его
