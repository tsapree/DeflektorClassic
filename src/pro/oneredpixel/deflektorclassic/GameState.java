	...
	int packedLevels[][] = {
		//01
		{
			...
			FLD_NULL|1,FLD_CELL,FLD_CELL,FLD_CELL,FLD_WALL_B|0x0a,FLD_CELL,FLD_CELL,FLD_WALL_A|0x05,
				FLD_NULL|4,FLD_CELL,FLD_NULL|3,FLD_WALL_A|0x05,
			FLD_NULL|1,FLD_CELL,FLD_MIRROR,FLD_AUTOROTATING,FLD_CELL,FLD_WALL_B|0x0f,FLD_PRISM,FLD_WALL_A|0x0c,
				FLD_WALL_A|0x0c,FLD_NULL|5,FLD_SLIT_B|7,FLD_NULL|2,
			FLD_NULL|1,FLD_CELL,FLD_CELL,FLD_CELL,FLD_WALL_B|0x0f,FLD_NULL|6,FLD_WARPBOX|1,FLD_NULL|4,FLD_MIRROR,FLD_NULL|2,
			...
			FLD_NULL|2,FLD_MIRROR,FLD_NULL|11,FLD_MIRROR,FLD_NULL|2,
			FLD_NULL|10,FLD_MINE,FLD_SLIT_B|7, FLD_NULL|2,
