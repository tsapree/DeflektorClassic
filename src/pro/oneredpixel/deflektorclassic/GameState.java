...
public class GameState extends State {
	...
	int packedLevels[][] = {
		...
		//36
		{
			...
			WARP|0,NULL|7,SL_B,NULL|6,
			MIRR,NULL|3,SL_A,SL_A,NULL|2,CELL,SL_B,NULL|2,MIRR,NULL,WL_B|14,
			NULL|7,SL_A,NULL|3,WL_A|3,WL_A|3,WL_A|3,WL_B|10,
			MINE,SL_B,NULL,WARP|1,WARP|0,NULL|3,WARP|1,NULL|2,CELL,CELL,CELL,WL_B|10,
			...
			WL_B|15,NULL,CELL,CELL,SL_B,NULL,MIRR,WL_A|10,CELL,CELL,PRSM,MINE,WL_B|14,WL_B|12,WL_B|8,
		},
		//37
		{
			1024, //energySteps
			...
			NULL,MINE,NULL,MIRR,NULL,WL_A|3,SL_A,NULL,CELL,NULL|3,MIRR,NULL|2,
			NULL,WL_A|3,WL_A|3,MIRR,NULL|2,SL_A,NULL|2,WL_A|6,WL_A|10,WL_A|1,WL_A|3,WL_A|14,WARP|0,
		...
		//39
		{
			...
			CELL,SL_A,CELL,CELL,CELL,CELL,CELL,CELL,CELL,CELL,CELL,MIRR,CELL,CELL,CELL,
			CELL,CELL,CELL,CELL,CELL,CELL,CELL,CELL,CELL,CELL,CELL,CELL,CELL,CELL,CELL,
		...
		//40
		{
			...
			CELL,MIRR,NULL,SL_A,CELL,MIRR,NULL,SL_A,CELL,MIRR,NULL,SL_A,NULL,MIRR,NULL,
			MIRR,NULL,MIRR,CELL,MIRR,NULL,MIRR,NULL,MIRR,NULL,MIRR,CELL,MIRR,NULL,MIRR,
			CELL,MIRR,NULL,SL_A,NULL,MIRR,CELL,SL_A,NULL,MIRR,NULL,SL_A,NULL,MIRR,MINE,
		...
		//41
		{
			...
			WL_A|15,NULL|5,SL_A,NULL,WL_A|13,NULL|2,WL_A|15,CELL,PRSM,CELL,
			WL_A|10,NULL,PRSM,NULL,WL_A|11,NULL,WL_A|3,NULL|4,WL_A|5,CELL,CELL,CELL,
			WL_A|10,NULL|3,WL_A|5,NULL,WL_A|5,NULL,MIRR,NULL,SL_A,WL_A|5,WL_A|12,WL_A|12,WL_A|12,
		...
		{
			1024, //energySteps
			SL_A,MINE,MIRR,NULL,SL_A,SL_A,NULL|2,CELL,MINE,NULL|2,SL_A,NULL,RCVR|2,
			MINE,NULL|6,SL_A,NULL|2,MINE,NULL|2,CELL,SL_A|EXPLODE,
			LASR|1,NULL,MIRR,NULL,SL_A,SL_A,NULL|5,SL_A,NULL|2,MIRR,
			NULL|7,MIRR,NULL,SL_A,NULL|3,SL_A,NULL,
			MINE,SL_A,SL_A,NULL|3,CELL,NULL|2,SL_A,NULL,MIRR,NULL,CELL,NULL,
			NULL|2,CELL,NULL,SL_A,NULL|2,SL_A,NULL,CELL,NULL|4,SL_A,
			NULL,SL_A,NULL|7,MIRR,NULL,SL_A,SL_A,SL_A,MINE,
			CELL,NULL,SL_A,NULL,MIRR,NULL,SL_A,SL_A,MINE,NULL|3,CELL,NULL|2,
			MINE,MIRR,NULL|4,CELL,NULL|4,SL_A,NULL,MIRR,CELL,			
		},
		//48
		{
			1024, //energySteps
			WL_A|14,WL_A|12,WL_A|12,WL_A|12,WL_A|12,WL_A|10,MIRR,NULL,CELL,WL_A|15,CELL,NULL,WL_A|5,WL_A|15,
			...
			NULL,WL_A|13,WL_A|12,WL_A|12,WL_A|12,WL_A|15,WL_A|15,NULL,MIRR,NULL,WL_A|14,NULL,WL_A|13,WL_A|11,
		...
		//50
		{
			...
			NULL,MIRR,CELL,MIRR,NULL,MIRR,NULL,MIRR,NULL,MIRR,NULL,MIRR,NULL,MIRR,NULL,
			RCVR,NULL,MIRR,CELL,MIRR,NULL,MIRR,MINE,MIRR,CELL,MIRR,NULL,MIRR,CELL,LASR,
			MINE,MIRR,NULL,MIRR,MINE,MIRR,CELL,MIRR,NULL,MIRR,CELL,MIRR,NULL,MIRR,CELL,
			MIRR,NULL,MIRR,NULL,MIRR,NULL,MIRR,NULL,MIRR,NULL,MIRR,NULL,SL_B,NULL,MIRR,
		...
		//51
		{
			...
			WL_A|2,MIRR,NULL|3,WL_B,SL_B|1,PRSM,WL_B|2,SL_B,NULL,MIRR,CELL,MIRR,MINE,
			WL_A|10,NULL,SL_A,CELL,SL_A,NULL,WL_A|14,NULL,WL_A|13,NULL,WL_A|1,WL_A|3,WL_A|3,WL_A|3,WL_A|3,
			CELL,WL_A|3,WL_A|3,WL_A|3,WL_A|3,CELL,WL_B|10,LASR,WL_A|5,MIRR,NULL,CELL,NULL,WL_B|10|EXPLODE,RCVR|3,
		},
		//52
		{
			1024, //energySteps
			...
			CELL,NULL|13,CELL,
			SL_A,CELL,SL_A,NULL,SL_A,NULL,SL_A,NULL,SL_A,NULL,SL_A,NULL,SL_A,CELL,SL_A,
			CELL,NULL,CELL,NULL|9,CELL,NULL,CELL,
			SL_A,CELL,SL_A,NULL,SL_A,NULL,SL_A,NULL,SL_A,NULL,SL_A,NULL,SL_A,CELL,SL_A,
		},
		//53
		{
			1024, //energySteps
			WL_A|10,MINE,CELL,MIRR,NULL|4,SL_B,CELL,MINE,WL_A|5,WL_A|15,WL_A|15,WL_A|15,
			...
			MIRR,NULL,WARP|0,MINE,CELL,WL_A|10,WL_A|5,WL_A|2,MINE,WL_A|13,WL_A|10,MIRR,
		...
		//58
		{
			...
			WL_B,WL_B|5,WL_B|3,MIRR,WL_B|3,MIRR,WL_B|7,WL_B|12,WL_B|11,MIRR,WL_B|3,MIRR,WL_B|3,WL_B|10,WL_B,
		},
		//59
		{
			1024, //energySteps
			...
			SL_B,WL_B|15,MIRR,MIRR,MIRR,MIRR,MIRR,MIRR,MIRR,MIRR,MIRR,MIRR,MIRR,WL_B|15,SL_B,
		...
		//60
		{
			1024, //energySteps
			CELL,CELL,CELL,CELL,CELL,CELL,CELL,CELL,CELL,CELL,CELL,CELL,CELL,CELL,CELL,
			CELL,PRSM,CELL,PRSM,CELL,PRSM,CELL,RCVR,CELL,PRSM,CELL,PRSM,CELL,PRSM,CELL,
			...
			CELL,PRSM,CELL,PRSM,CELL,PRSM,CELL,LASR,CELL,CELL,CELL,PRSM,CELL,PRSM,CELL,
